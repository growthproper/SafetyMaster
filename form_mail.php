 ...
 <?php
 		$mailSubject = "Customer New Inquiry 상담요청 메일";
        $mailTo		=	"safetymaster@safetymaster.net";
	    // 받는사람 메일 주소;
        $mailFrom	=	"fromnet@naver.com";	
        // 보내는사람 메일주소 
        $name = $_POST['name'] ;
...
<body>
 ...
 <div style="width:60%;margin: 0 auto;text-align: center;font-weight: bold;">
 	<p style="font-size: 30px;"><? echo ''.$name.'님 상담을 요청해주셔서 감사합니다.' ?></p>
 	...
 	<button style="margin-top:120px;background:#007bc1;width:150px;height:50px;border-radius:5px;border:none;"><a href="https://safetymaster.co.kr/request.html" style="text-decoration: none;color: #fff;font-weight: bold;font-size:18px;">확인</button>
 </div>
</body>
</html>
